...
// FIX: Removed ApiKeyManager as per guidelines to not handle API key in the UI.
...
const App: React.FC = () => {
  // FIX: Removed apiKey state and session storage logic. API key is now handled via environment variables.
  ...
  // FIX: Removed API key submission handler.
  ...
  // FIX: Removed conditional rendering of ApiKeyManager.
  // if (!apiKey) {
